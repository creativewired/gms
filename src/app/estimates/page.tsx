        ...
        <table className="min-w-full text-sm">
          ...
          <tbody>
            {estimates && estimates.length > 0 ? (
              estimates.map((e, i) => (
                <tr key={e.id} className={`hover:bg-slate-50/70 transition-colors ${i !== 0 ? "border-t border-slate-50" : ""}`}>
                  ...
                  <td className="px-6 py-4">
                    <Link href={`/estimates/${e.id}`} className="text-xs text-slate-400 hover:text-slate-800 transition-colors">
                      View →
                    </Link>
                  </td>
                </tr>
