      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2 space-y-5">
          ...
          <div className="card p-6">
            <p className="section-title">Vehicle & Customer</p>
...
/>
          ...
          {/* Signature — below invoice on left col */}
          <SignatureSection
            jobId={job.id}
          ...
          <div className="card p-5 space-y-4">
            ...
            {[
              ...
              <div key={row.label} className="flex items-start justify-between">
                ...
                <p className="text-xs font-semibold text-slate-700 text-right capitalize">
                  {row.value}
                </p>
              </div>
            ))}
                ...
                <div className="rounded-xl p-3"
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-semibold" style={{
                      color: job.payment_status === "pending" ? "#1d4ed8" : "#8e8e93"
                    }}>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 p-2 rounded-lg"
                      ...
                      <p className="text-xs text-slate-400 truncate flex-1 font-mono">
                        {job.payment_link.replace("https://", "").slice(0, 30)}...
                      </p>
                      <button
                        onClick={() => navigator.clipboard.writeText(job.payment_link)}
